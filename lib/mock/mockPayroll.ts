...
export const ROLE_BASE_SALARY: Record<Role, number> = {
  ...
  FINANCE_ASSISTANT: 800000,
  ADMISSIONS_ASSISTANT: 800000,
  TRAVEL_ASSISTANT: 800000,
  OPERATIONS_ASSISTANT: 800000,
  MARKETING_STAFF_ASSISTANT: 700000,
  BUSINESS_DEVELOPMENT_ASSISTANT: 800000,
};
...
const make = (
  ...
  return {
    ...
    baseSalary: base,
    allowances,
    grossSalary: base + allowances,
    deductions,
    tax,
    pension,
    taxableSalary: base + allowances - pension,
    netPay: net,
    status,
    paidDate,
...
export const mockPayroll: PayrollEntry[] = [
  ...
  make('PR-2026-FEB-004', 'usr_004', 'Cosmas Cosmas', 'FINANCE', 'Finance', 'February 2026', '2026-02-01T00:00:00Z', '2026-02-28T00:00:00Z', 2800000, 'PAID', '2026-02-28T00:00:00Z'),
  make('PR-2026-FEB-005', 'usr_005', 'Justice Mwampiki', 'ADMISSIONS', 'Admissions', 'February 2026', '2026-02-01T00:00:00Z', '2026-02-28T00:00:00Z', 2200000, 'PAID', '2026-02-28T00:00:00Z'),
  make('PR-2026-FEB-006', 'usr_006', 'Wisdom Mwaipape', 'TRAVEL', 'Travel', 'February 2026', '2026-02-01T00:00:00Z', '2026-02-28T00:00:00Z', 2200000, 'PAID', '2026-02-28T00:00:00Z'),
  make('PR-2026-FEB-007', 'usr_007', 'Lucy Masine', 'OPERATIONS', 'Operations', 'February 2026', '2026-02-01T00:00:00Z', '2026-02-28T00:00:00Z', 2200000, 'PAID', '2026-02-28T00:00:00Z'),
  make('PR-2026-FEB-008', 'usr_008', 'Ayoub Mgassa', 'MARKETING_STAFF', 'Marketing', 'February 2026', '2026-02-01T00:00:00Z', '2026-02-28T00:00:00Z', 1500000, 'PAID', '2026-02-28T00:00:00Z'),
  ...
  make('PR-2026-MAR-004', 'usr_004', 'Cosmas Cosmas', 'FINANCE', 'Finance', 'March 2026', '2026-03-01T00:00:00Z', '2026-03-31T00:00:00Z', 2800000, 'APPROVED'),
  make('PR-2026-MAR-005', 'usr_005', 'Justice Mwampiki', 'ADMISSIONS', 'Admissions', 'March 2026', '2026-03-01T00:00:00Z', '2026-03-31T00:00:00Z', 2200000, 'APPROVED'),
  make('PR-2026-MAR-006', 'usr_006', 'Wisdom Mwaipape', 'TRAVEL', 'Travel', 'March 2026', '2026-03-01T00:00:00Z', '2026-03-31T00:00:00Z', 2200000, 'APPROVED'),
  make('PR-2026-MAR-007', 'usr_007', 'Lucy Masine', 'OPERATIONS', 'Operations', 'March 2026', '2026-03-01T00:00:00Z', '2026-03-31T00:00:00Z', 2200000, 'APPROVED'),
  make('PR-2026-MAR-008', 'usr_008', 'Ayoub Mgassa', 'MARKETING_STAFF', 'Marketing', 'March 2026', '2026-03-01T00:00:00Z', '2026-03-31T00:00:00Z', 1500000, 'DRAFT'),
