export const ROLES = {
  ...
  ADMISSIONS_ASSISTANT: 'ADMISSIONS_ASSISTANT',
  TRAVEL_ASSISTANT: 'TRAVEL_ASSISTANT',
  OPERATIONS_ASSISTANT: 'OPERATIONS_ASSISTANT',
  MARKETING_STAFF_ASSISTANT: 'MARKETING_STAFF_ASSISTANT',
  BUSINESS_DEVELOPMENT_ASSISTANT: 'BUSINESS_DEVELOPMENT_ASSISTANT',
} as const;
